...
public class EvenTeaseBackApplication implements CommandLineRunner {
	...
	DateFormat d = new SimpleDateFormat("dd/MM/yyyy");
		...
		eventRepo.save(e1);
		Event e2 = new Event(null, "petit lazer game les boys", d.parse("27/02/2022"), "Paris", true,"fait attention à ton petit cul", null, u2, null, null, null);
		eventRepo.save(e2);
		Event e3 = new Event(null, "maxpea organise 2", d.parse("27/02/2022"), "Paris", true,"oyeah", null, u2, null, null, null);
		eventRepo.save(e3);
		Event e4 = new Event(null, "maxpea organise 3", d.parse("27/02/2022"), "Paris", true,"oyeah", null, u2, null, null, null);
		eventRepo.save(e4);
		Event e5 = new Event(null, "gadjo participe party 1", d.parse("27/02/2022"), "Paris", true,"oyeah", null, u1, null, null, null);
		eventRepo.save(e5);
		Event e6 = new Event(null, "gadjo participe party 2", d.parse("27/02/2022"), "Paris", true,"oyeah", null, u3, null, null, null);
		eventRepo.save(e6);
		Event e7 = new Event(null, "gadjo participe party 3", d.parse("27/02/2022"), "Paris", true,"oyeah", null, u4, null, null, null);
		eventRepo.save(e7);
